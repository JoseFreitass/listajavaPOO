...
{
    String cor1 = pracinha.jardimA.getFlor1().GetPetala().getCor();
    String cor2 = pracinha.jardimA.getFlor2().GetPetala().getCor();
    String cor3 = pracinha.jardimB.getFlor1().GetPetala().getCor();
    String cor4 = pracinha.jardimB.getFlor2().GetPetala().getCor();
